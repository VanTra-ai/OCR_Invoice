/*! svg.select.js v2.1.2 MIT*/ !(function () {
  "use strict";
  function SelectHandler(el) {
    (this.el = el),
      ...
      (this.pointCoord = function (setting, object) {
        return "string" != typeof setting ? setting : eval("object." + setting);
      }),
      (this.pointCoords = function (t, e) {
        var i = this.pointsList[t];
        return { x: this.pointCoord(i[0], e), y: this.pointCoord(i[1], e) };
      });
  }
  (SelectHandler.prototype.init = function (t, e) {
    var i = this.el.bbox();
    this.options = {};
    ...
    for (var s in o) {
      ...
      "string" == typeof r
        ...
        : "boolean" == typeof r && "points" === o[s] && (r = r ? n : []),
        (this.options[o[s]] = r);
    }
    ...
    (SelectHandler.prototype.selectPoints = function (t) {
      return (
      ...
      for (
        ...
        var n = (function (n) {
            return function (t) {
              ...
              s.el.fire("point", { x: e, y: i, i: n, event: t });
            };
          })(e),
          o = this.drawPoint(t[e][0], t[e][1])
    ...
    (SelectHandler.prototype.drawPoint = function (t, e) {
    ...
    (SelectHandler.prototype.drawCircle = function (t, e) {
      return this.nested.circle(this.options.pointSize).center(t, e);
    }),
    (SelectHandler.prototype.drawRect = function (t, e) {
      return this.nested
      ...
      if (
        ...
        this.options.points.length &&
          this.options.points.map(function (t, e) {
            var i = n.pointCoords(t, s);
            n.rectSelection.set.get(e + 1).center(i.x, i.y);
          }),
    ...
    (SelectHandler.prototype.selectRect = function (t) {
      var s = this,
        o = this.el.bbox();
      function r(n) {
        return function (t) {
      ...
      if (
        ...
        this.rectSelection.set.get(0) ||
          this.rectSelection.set.add(
            this.nested.rect(o.width, o.height).addClass(this.options.classRect)
          ),
        this.options.points.length && this.rectSelection.set.length() < 2)
      ) {
        this.options.points.map(function (t, e) {
          var i = s.pointCoords(t, o),
            n = s
              .drawPoint(i.x, i.y)
              .attr("class", s.options.classPoints + "_" + t)
              .on("mousedown", r(t))
              .on("touchstart", r(t));
          s.rectSelection.set.add(n);
        }),
    ...
    SVG.extend(SVG.Element, {
      selectize: function (t, e) {
        return (
          ...
          (this.remember("_selectHandler") || new SelectHandler(this)).init(
            void 0 === t || t,
            e || {}
          ),
          this
