  ...
  (t = function () {
        ...
        return function (e, t) {
          ...
          if (i) {
            ...
            if ("." === s) "." === e[n - 1] && (t = o);
              ...
              (e[--n] !== s || (n = f(e, n)) < 0 || !p.test(e[n])) && (t = o);
            else if (~c.indexOf(s)) {
        ...
        function h(e) {
          ...
          return (
            ((t = t.concat(e.replace(a, "\\").split(" ")))[4] = d(
              1 < t[1].length ? /{[\S\s]*?}/ : l[4],
              t
            )),
            (t[5] = d(3 < e.length ? /\\({|})/g : l[5], t)),
            (t[6] = d(l[6], t)),
            (t[7] = RegExp(
              "\\\\(" + t[3] + ")|([[({])|(" + t[3] + ")|" + u,
              n
          ...
          (m.split = function (n, i, t) {
            ...
            for (r = o = l.lastIndex = 0; (e = l.exec(n)); ) {
              ...
              e[1] ||
                (g(n.slice(o, s)),
                (o = l.lastIndex),
                ((l = t[6 + (r ^= 1)]).lastIndex = o));
            }
            return n && o < n.length && g(n.slice(o)), (c.qblocks = p), c;
            function g(e) {
              f && ((e = f + e), (f = "")),
                i || r ? c.push(e && e.replace(t[5], "$1")) : c.push(e);
            }
            function v(e, t, r) {
              return (
                r && (t = M(n, e)),
          ...
          Object.defineProperties(a, {
            ...
            trigger: {
              value: function (e) {
                ...
                for (t = c.call(u[e] || [], 0), n = 0; (r = t[n]); ++n)
                  r.apply(a, s);
                return (
    ...
    function q(e) {
      for (var t, r = 1, n = arguments, i = n.length; r < i; r++)
        if ((t = n[r])) for (var o in t) B(e, o) && (e[o] = t[o]);
      return e;
    }
    function D(e) {
      return Object.create(e);
    }
    var Z = q(D(P.settings), { skipAnonymousTags: !0, autoUpdate: !0 });
    function G(e, t) {
    ...
    function ye(e, t, r, n) {
      return (
        Object.defineProperty(
          e,
          t,
          q({ value: r, enumerable: !1, writable: !1, configurable: !0 }, n)
        ),
        e
      );
    }
    ...
    function Fe(e, t, r, n) {
      var i,
        o = function (e, t, r) {
          ...
          if (
            (B(r, "currentTarget") && (r.currentTarget = e),
            B(r, "target") && (r.target = r.srcElement),
            B(r, "which") && (r.which = r.charCode || r.keyCode),
            (r.item = i),
            t.call(this, r),
            Z.autoUpdate && !r.preventUpdate)
          ) {
            var o = $e(this);
      ...
      (r[e] = null),
        (i = e.replace(w, "")),
        he(n.__.listeners, r) || n.__.listeners.push(r),
        r[b] || (r[b] = {}),
        r[b][e] && r.removeEventListener(i, r[b][e]),
        (r[b][e] = o),
      ...
      if (!this.root || !J(this.root, "virtualized")) {
        ...
        if (e._riot_id)
          ...
          var p,
            ...
            b = ue(r);
          if (
            (b && (l ? (r = z(JSON.stringify(r), this)) : c && (r = re(r))),
            !e.attr ||
              (e.wasParsedOnce && y && !1 !== r) ||
              Q(n, J(n, e.attr) ? e.attr : i),
            e.bool && (r = !!r && i),
            e.isRtag)
          )
            return (
              ...
              void (m && p.tagName === d
                ? m.update()
                : (m &&
                    (v && ((h = K()), g.parentNode.insertBefore(h, g)),
                    m.unmount(!0)),
                  fe(d) &&
                    ((p.impl = $[d]),
                    p.impl &&
          ...
          if (
            ...
            ((e.value = r), (e.wasParsedOnce = !0), !b || l || c || o)
          ) {
            if ((y || (r = ""), !i))
              return (
                (r += ""),
      ...
      if (!e || !r) {
        ...
        me(i, function (e) {
          e.expr && Be.call(o, e.expr),
            (n[be(e.name).replace(_, "")] = e.expr ? e.expr.value : e.value);
        });
      }
    }
    function Ze(e) {
    ...
    function Ge(e, t) {
      var r = this,
        ...
        a = r.onCreate;
      return (
        $[n] || (Ke(n, i, o, s, a), ($[n].class = this.constructor)),
        xt(e, n, t, this),
        o && R.inject(),
        this
      );
    ...
    function Ke(e, t, r, n, i) {
      return (
        ...
        r && (ae(r) ? (i = r) : R.add(r, e)),
        (e = e.toLowerCase()),
        ($[e] = { name: e, tmpl: t, attrs: n, fn: i }),
        e
      );
    }
    function We(e, t, r, n, i) {
      return (
        r && R.add(r, e), ($[e] = { name: e, tmpl: t, attrs: n, fn: i }), e
      );
    }
    function Je(e, i, o) {
      var t,
                ...
                h
                  ...
                  : p !== t &&
                    ...
                    ((E || he(m, P[p])) &&
                      ...
                      L.splice(t, 0, L.splice(p, 1)[0]),
                      P.splice(t, 0, P.splice(p, 1)[0])),
                    O.pos && (f[O.pos] = t),
                    !k &&
                      f.tags &&
                      function (t) {
                  ...
                  q(f.__, { item: r, index: t, parent: A }),
                  (y[t] = a),
                  h || f.update(r);
              } else w++;
            }),
              (function (e, t, r) {
                for (var n = t.length, i = e.length - r; i < n; )
                  at.apply(t[--n], [t, n]);
              })(m, L, w),
              (P = y.slice()),
              x.insertBefore(g, t);
    ...
    var ct = {
      ...
      update: function () {
        ...
        (this.value = this.hasExp
          ? z(this.rawValue, this.parent)
          : this.rawValue),
          !se(e) && t && He(t.refs, e, r),
          !se(this.value) && fe(this.value)
    ...
    var ft = {
      ...
      update: function () {
        (this.value = z(this.expr, this.tag)),
        ...
        ne(a, function (e) {
          ...
          if (
            ...
            (3 === n &&
              ...
              z.hasExpr(e.nodeValue) &&
              l.push({ dom: e, expr: e.nodeValue }),
            1 === n)
          ) {
            var i = "VIRTUAL" === e.tagName;
            if ((t = J(e, d)))
              return i && k(e, "loopVirtual", !0), l.push(ut(e, c, t)), !1;
            if ((t = J(e, f))) return l.push(dt(e, c, t)), !1;
            if ((t = J(e, p)) && z.hasExpr(t))
              return (
                l.push({
                  isRtag: !0,
                  expr: t,
            ...
            if (
              ((r = Oe(e)),
              i &&
                (J(e, "virtualized") && e.parentElement.removeChild(e),
                r ||
                  J(e, "virtualized") ||
                  J(e, "loopVirtual") ||
                  (r = { tmpl: e.outerHTML })),
              ...
              if (!i || o)
                return (
                  ...
                  l.push(ze(r, { root: e, parent: c }, e.innerHTML, c)),
                  !1
                );
              k(e, "virtualized", !0);
              var s = vt(
    ...
    function mt(i, e, o) {
      ...
      me(e, function (e) {
        ...
        var t,
          r = e.name,
          n = pe(r);
        he(u, r) && i.tagName.toLowerCase() !== a
          ? (t = lt(i, s, r, e.value))
          : z.hasExpr(e.value) &&
          ...
          [
            ...
            function (e) {
              return (
                ...
                i.isAnonymous && i.parent && q(t, i.parent),
                q(t, r),
                De.apply(t, [
                  i.isLoop,
                  i.parent,
              ...
              return (function (r, e, n, t) {
                ...
                (o._tag = r),
                  mt.apply(i.parent, [
                    ...
                    o.attributes,
                    function (e, t) {
                      !i.isAnonymous && ct.isPrototypeOf(t) && (t.tag = r),
                        (e.expr = t),
                        i.instAttrs.push(e);
                    },
                  ]),
                ...
                if (
                  ...
                  me(ht.apply(r, [e, i.isAnonymous]), function (e) {
                    return n.push(e);
                  }),
                  r.update(i.item),
    ...
    function xt(e, t, r, n) {
      ...
      return (
        o && e && (i = vt(o, c, u)),
        i && i.mount && (i.mount(!0), he(x, i) || x.push(i)),
        i
      );
    }
    var yt = Object.freeze({
      ...
      jt = rt,
      St = H,
      kt = q({}, nt, { observable: H, settings: bt, util: wt }),
      Tt = Object.freeze({
        settings: bt,
        util: wt,
        Tag: _t,
    ...
    function cr(e) {
      ...
      for (e = c.shift().join("<%>"); (t = e.match(ur)); )
        a.push(u.leftContext),
          (n = l((e = u.rightContext))),
          (i = t[1]),
          (o = t[2] || ""),
          (s = t[3]),
    ...
    function lr(e, t, r, n, i) {
      return /\S/.test(e)
        ? (r || (r = t.type),
          (t.parser || (r && It._req("js." + r, !0)) || cr)(e, n, i)
            .replace(/\r\n?/g, "\n")
            .replace(Jt, ""))
        : "";
    }
    ...
    function fr(e, t, r, n) {
      ...
      return (
        (e = e.replace(P.R_MLCOMMS, "").replace(/\s+/g, " ").trim()),
        t &&
          ((i = t),
          (o = ":scope"),
      ...
      Nr = {
        compile: function (e, b, w) {
          ...
          return (
            ...
            (t = nr(t).replace(br, function (e, t, l, r, n, i) {
              var o,
                s,
                a,
                u,
                    ...
                    (n = (n = (n = n.replace(
                      ...
                      if (_("js")) {
                        var n =
                          ...
                          (u = vr((s = t))),
                          (c = xr(s, "src")),
                          (l = Ft({}, o.parserOptions.js)),
                          !c && lr(i, o, u, Ft(l, yr(s)), a));
                        n && (h += (h ? "\n" : "") + n);
                      }
                      var i, o, s, a, u, c, l;
                      return "";
        ...
        compileJS: function (e, t, r, n) {
          return (
            ...
            n || (n = {}),
            lr(e, t || {}, r, n.parserOptions, n.url)
          );
        },
        parsers: It,
        version: "v3.4.0",
    ...
    function Sr(e, i, t) {
      if (typeof e === c) {
        ...
        if ((ae(e) ? ((t = i), (i = e)) : ((t = e), (i = void 0)), Or))
          return i && i();
        Ar
          ? i && Ar.on("ready", i)
          : ((Ar = H()),
