/*! svg.js v2.6.5 MIT*/ !(function (t, e) {
  ...
  if (
    ...
    (w.supported = (function () {
      return (
        !!e.createElementNS && !!e.createElementNS(w.ns, "svg").createSVGRect
      );
    })()),
    !w.supported)
  )
  ...
  (w.did = 1e3),
      ...
      return (
        (i =
          "svg" == e.nodeName
            ...
            ? new w.Gradient("linear")
            : "radialGradient" == e.nodeName
            ? new w.Gradient("radial")
            : w[a(e.nodeName)]
            ? new w[a(e.nodeName)]()
            : new w.Element(e)),
        (i.type = e.nodeName),
    ...
    (w.Color = function (t) {
      ...
      (this.r = 0),
        ...
        t &&
          ("string" == typeof t
            ? w.regex.isRgb.test(t)
              ? ((e = w.regex.rgb.exec(t.replace(w.regex.whitespace, ""))),
                (this.r = parseInt(e[1])),
                (this.g = parseInt(e[2])),
                (this.b = parseInt(e[3])))
              : w.regex.isHex.test(t) &&
                ((e = w.regex.hex.exec(h(t))),
    ...
    w.extend(w.PointArray, {
      ...
      bbox: function () {
        return (
          w.parser.poly.setAttribute("points", this.toString()),
  ...
  (w.PathArray = function (t, e) {
    ...
    w.extend(w.PathArray, {
      ...
      parse: function (t) {
        ...
        t =
          "string" == typeof t
            ? t
                .replace(w.regex.numbersWithDots, i)
                .replace(w.regex.pathLetters, " $& ")
                .replace(w.regex.hyphen, "$1 -")
                .trim()
                .split(w.regex.delimiter)
      ...
      bbox: function () {
        return (
          w.parser.path.setAttribute("d", this.toString()),
    ...
    (w.Number = w.invent({
        ...
        (this.value = 0),
          ...
          "number" == typeof t
            ? (this.value = isNaN(t)
                ...
                : 3.4e38)
            : "string" == typeof t
            ? (e = t.match(w.regex.numberAndUnit)) &&
              ((this.value = parseFloat(e[1])),
              "%" == e[5]
                ? (this.value /= 100)
                : "s" == e[5] && (this.value *= 1e3),
              (this.unit = e[5]))
            : t instanceof w.Number &&
      ...
      extend: {
        ...
        plus: function (t) {
          return (
            (t = new w.Number(t)), new w.Number(this + t, this.unit || t.unit)
          );
        },
        minus: function (t) {
          return (
        ...
        morph: function (t) {
          return (
            (this.destination = new w.Number(t)),
        ...
        at: function (t) {
          return this.destination
            ? new w.Number(this.destination).minus(this).times(t).plus(this)
            : this;
        },
      },
    })),
    (w.Element = w.invent({
      ...
      extend: {
        ...
        size: function (t, e) {
          var i = l(this, t, e);
          return this.width(new w.Number(i.width)).height(
            new w.Number(i.height)
          );
        },
        clone: function (t) {
          this.writeDataToDom();
    ...
    (w.FX = w.invent({
      ...
      extend: {
        ...
        target: function (t) {
          return t && t instanceof w.Element
            ? ((this._target = t), this)
            : this._target;
        },
        ...
        queue: function (t) {
          return (
            ("function" == typeof t || t instanceof w.Situation) &&
        ...
        dequeue: function () {
          return (
            ...
            this.situation &&
              (this.situation instanceof w.Situation
                ? this.start()
        ...
        initAnimations: function () {
          ...
          for (t in n.animations)
            for (
              ...
              n.animations[t][e] instanceof w.Number &&
                (i[e] = new w.Number(i[e])),
        ...
        eachAt: function () {
          ...
          if (s.transforms.length) {
            for (
              ...
              o instanceof w.Matrix
                ? (i = o.relative
                    ? i.multiply(new w.Matrix().morph(o).at(s.ease(this.pos)))
    ...
    (w.MorphObj = w.invent({
      create: function (t, e) {
        return w.Color.isColor(e)
          ? new w.Color(t).morph(e)
          : w.regex.delimiter.test(t)
          ? w.regex.pathLetters.test(t)
            ? new w.PathArray(t).morph(e)
            : new w.Array(t).morph(e)
          : w.regex.numberAndUnit.test(e)
          ? new w.Number(t).morph(e)
    ...
    w.extend(w.FX, {
      ...
      leading: function (t) {
        return this.target().leading
          ? this.add("leading", new w.Number(t))
          : this;
      },
      viewbox: function (t, e, i, n) {
        return (
          this.target() instanceof w.Container &&
            this.add("viewbox", new w.ViewBox(t, e, i, n)),
          this
        );
      },
      update: function (t) {
        ...
        transform: function (t) {
          ...
          return (
            [
              ...
              new w.Point(this.x2, this.y),
              new w.Point(this.x, this.y2),
              new w.Point(this.x2, this.y2),
            ].forEach(function (e) {
              (e = e.transform(t)),
                (i = Math.min(i, e.x)),
                (n = Math.max(n, e.x)),
    ...
    (w.BBox = w.invent({
      create: function (t) {
        if (
          (w.Box.apply(this, [].slice.call(arguments)), t instanceof w.Element)
        ) {
          var i;
          try {
    ...
    (w.RBox = w.invent({
      create: function (t) {
        w.Box.apply(this, [].slice.call(arguments)),
          t instanceof w.Element &&
            w.Box.call(this, t.node.getBoundingClientRect());
      },
      inherit: w.Box,
      parent: w.Element,
      extend: {
      ...
      construct: {
        rbox: function (t) {
          return t
            ? new w.RBox(this).transform(t.screenCTM().inverse())
            : new w.RBox(this).addOffset();
        },
      },
    })),
    ...
    (w.Matrix = w.invent({
        ...
        for (
          t =
            t instanceof w.Element
              ? t.matrixify()
              : "string" == typeof t
              ? f(t.split(w.regex.delimiter).map(parseFloat))
              : 6 == arguments.length
      ...
      extend: {
        ...
        skew: function (t, e, i, n) {
          return (
            ...
            this.around(
              i,
              n,
              new w.Matrix(1, Math.tan(e), Math.tan(t), 1, 0, 0)
            )
          );
        },
        ...
        native: function () {
          for (
            var t = w.parser.native.createSVGMatrix(), e = P.length - 1;
            e >= 0;
            e--
          )
            t[P[e]] = this[P[e]];
      ...
      attr: function (t, e, i) {
        if (null == t) {
          for (t = {}, e = this.node.attributes, i = e.length - 1; i >= 0; i--)
            t[e[i].nodeName] = w.regex.isNumber.test(e[i].nodeValue)
        ...
        if ("object" == typeof t) for (e in t) this.attr(e, t[e]);
          ...
          "stroke-width" == t
            ...
            "number" == typeof e
              ...
              : w.Color.isColor(e)
              ? (e = new w.Color(e))
              : Array.isArray(e) && (e = new w.Array(e)),
            "leading" == t
    ...
    w.extend(w.Element, {
      transform: function (t, e) {
        ...
        if ("object" != typeof t)
          return (
            (i = new w.Matrix(r).extract()), "string" == typeof t ? i[t] : i
          );
        if (((i = new w.Matrix(r)), (e = !!e || !!t.relative), null != t.a))
          ...
          if (
            ...
            var s = i.extract();
            i = i.multiply(
              new w.Matrix().skew(s.skewX, s.skewY, t.cx, t.cy).inverse()
            );
          }
          ...
          t.flip
            ? ("x" == t.flip || "y" == t.flip
                ...
                : (t.flip = t.offset),
              (i = new w.Matrix().flip(t.flip, t.offset)))
            : (null == t.x && null == t.y) ||
              (e
        ...
        return "object" != typeof t
          ...
          : ((e = !!e || !!t.relative),
            null != t.a
              ? (i = new w.Matrix(t))
              : null != t.rotation
              ? (p(t, r), (i = new w.Rotate(t.rotation, t.cx, t.cy)))
              ...
              ? ("x" == t.flip || "y" == t.flip
                  ...
                  : (t.flip = t.offset),
                (i = new w.Matrix().flip(t.flip, t.offset)))
              : (null == t.x && null == t.y) || (i = new w.Translate(t.x, t.y)),
            i
              ? ((i.relative = e),
    ...
    (w.Transformation = w.invent({
      ...
      extend: {
        ...
        at: function (t) {
          ...
          return (
            (r = new w.Matrix()
              .morph(w.Matrix.prototype[this.method].apply(r, e))
              .at(t)),
    ...
    w.extend(w.Element, {
      style: function (t, e) {
        ...
        if (arguments.length < 2)
          ...
          this.node.style[o(t)] =
            null === e || w.regex.isBlank.test(e) ? "" : e;
        return this;
      },
    }),
    (w.Parent = w.invent({
      ...
      extend: {
        children: function () {
          return w.utils.map(
            w.utils.filterSVGElements(this.node.childNodes),
            function (t) {
              return w.adopt(t);
            }
          );
      ...
      ungroup: function (t, e) {
        return 0 === e || this instanceof w.Defs || this.node == w.parser.draw
          ...
          : ((t = t || (this instanceof w.Doc ? this : this.parent(w.Parent))),
            (e = e || 1 / 0),
            this.each(function () {
              return this instanceof w.Defs
                ? this
                : this instanceof w.Parent
                ? this.ungroup(t, e - 1)
                : this.toParent(t);
            }),
        ...
        if (t instanceof w.Element) {
          for (
            o = t,
              ...
              r = new w.Number(t.height());
            "%" == n.unit;

          )
            (u *= n.value),
              (n = new w.Number(
                o instanceof w.Doc ? o.parent().offsetWidth : o.parent().width()
              )),
              (o = o.parent());
          for (; "%" == r.unit; )
            (l *= r.value),
      ...
      construct: {
        viewbox: function (t, e, i, n) {
          return 0 == arguments.length
            ? new w.ViewBox(this)
            : this.attr("viewBox", new w.ViewBox(t, e, i, n));
        },
      },
    })),
    [
    ...
    (w.off = function (t, e, i) {
      ...
      if (-1 != n)
        if (i) {
          ...
          w.listeners[n][r] &&
            w.listeners[n][r][s || "*"] &&
            (t.removeEventListener(r, w.listeners[n][r][s || "*"][i], !1),
        ...
        return (
          e instanceof t.Event
            ...
            : this.node.dispatchEvent(
                (e = new w.CustomEvent(e, { detail: i, cancelable: !0 }))
              ),
          (this._event = e),
          this
        );
    ...
    (w.Doc = w.invent({
      ...
      extend: {
        namespace: function () {
          return this.attr({ xmlns: w.ns, version: "1.1" })
            .attr("xmlns:xlink", w.xlink, w.xmlns)
            .attr("xmlns:svgjs", w.svgjs, w.xmlns);
        },
        defs: function () {
          if (!this._defs) {
            var t;
            (t = this.node.getElementsByTagName("defs")[0])
              ? (this._defs = w.adopt(t))
              : (this._defs = new w.Defs()),
    ...
    (w.Mask = w.invent({
      ...
      extend: {
        remove: function () {
          ...
          return (
            (this.targets = []), w.Element.prototype.remove.call(this), this
          );
        },
      },
      construct: {
    ...
    w.extend(w.Element, {
      maskWith: function (t) {
        return (
          (this.masker = t instanceof w.Mask ? t : this.parent().mask().add(t)),
    ...
    w.extend(w.Element, {
      clipWith: function (t) {
        return (
          (this.clipper =
            t instanceof w.ClipPath ? t : this.parent().clip().add(t)),
    ...
    w.extend(w.Gradient, w.FX, {
      from: function (t, e) {
        return "radial" == (this._target || this).type
          ? this.attr({ fx: new w.Number(t), fy: new w.Number(e) })
          : this.attr({ x1: new w.Number(t), y1: new w.Number(e) });
      },
      to: function (t, e) {
        return "radial" == (this._target || this).type
          ? this.attr({ cx: new w.Number(t), cy: new w.Number(e) })
    ...
    (w.Stop = w.invent({
      ...
      extend: {
        update: function (t) {
          return (
            ("number" == typeof t || t instanceof w.Number) &&
              (t = {
                offset: arguments[0],
                color: arguments[1],
                opacity: arguments[2],
    ...
    (w.Circle = w.invent({
      ...
      construct: {
        circle: function (t) {
          return this.put(new w.Circle())
            .rx(new w.Number(t).divide(2))
            .move(0, 0);
        },
      },
    })),
    ...
    w.extend(w.Circle, w.Ellipse, {
      ...
      size: function (t, e) {
        var i = l(this, t, e);
        return this.rx(new w.Number(i.width).divide(2)).ry(
          new w.Number(i.height).divide(2)
        );
      },
    }),
    (w.Line = w.invent({
      ...
      construct: {
        line: function (t, e, i, n) {
          return w.Line.prototype.plot.apply(
            this.put(new w.Line()),
    ...
    w.extend(w.Polyline, w.Polygon, {
      array: function () {
        return (
          this._array || (this._array = new w.PointArray(this.attr("points")))
        );
      },
      plot: function (t) {
        return null == t
          ...
          : this.clear().attr(
              "points",
              "string" == typeof t ? t : (this._array = new w.PointArray(t))
            );
      },
      clear: function () {
      ...
      extend: {
        ...
        plot: function (t) {
          return null == t
            ...
            : this.clear().attr(
                "d",
                "string" == typeof t ? t : (this._array = new w.PathArray(t))
              );
        },
        clear: function () {
          return delete this._array, this;
    ...
    (w.Text = w.invent({
      ...
      extend: {
        ...
        leading: function (t) {
          return null == t
            ? this.dom.leading
            : ((this.dom.leading = new w.Number(t)), this.rebuild());
        },
        lines: function () {
          var t = ((this.textPath && this.textPath()) || this).node,
            e = w.utils.map(
              w.utils.filterSVGElements(t.childNodes),
              function (t) {
                return w.adopt(t);
              }
            );
    ...
    (w.TextPath = w.invent({
      ...
      construct: {
        ...
        path: function (t) {
          for (
            var e = new w.TextPath(), i = this.doc().defs().path(t);
    ...
    w.extend(w.Line, w.Polyline, w.Polygon, w.Path, {
      marker: function (t, e, i, n) {
        ...
        return (
          ...
          (r = r.join("-")),
          (t =
            arguments[1] instanceof w.Marker
              ? arguments[1]
  ...
  ["fill", "stroke"].forEach(function (t) {
    ...
    w.extend(w.Element, w.FX, {
      ...
      matrix: function (t) {
        return this.attr(
          "transform",
          new w.Matrix(6 == arguments.length ? [].slice.call(arguments) : t)
        );
      },
      opacity: function (t) {
      ...
      dx: function (t) {
        return this.x(
          new w.Number(t).plus(this instanceof w.FX ? 0 : this.x()),
          !0
        );
      },
      dy: function (t) {
        return this.y(
          new w.Number(t).plus(this instanceof w.FX ? 0 : this.y()),
          !0
        );
      },
      dmove: function (t, e) {
    ...
    (w.Set.inherit = function () {
      ...
      for (var t in w.Shape.prototype)
        "function" == typeof w.Shape.prototype[t] &&
          "function" != typeof w.Set.prototype[t] &&
          e.push(t);
      e.forEach(function (t) {
        w.Set.prototype[t] = function () {
          ...
          return "animate" == t
            ? this.fx || (this.fx = new w.FX.Set(this))
            : this;
        };
      }),
        (e = []);
      for (var t in w.FX.prototype)
        "function" == typeof w.FX.prototype[t] &&
          "function" != typeof w.FX.Set.prototype[t] &&
          e.push(t);
      e.forEach(function (t) {
